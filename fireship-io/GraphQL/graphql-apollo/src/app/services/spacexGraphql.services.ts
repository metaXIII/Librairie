...
export type PastLaucnhesListQueryVariables = Exact<{
  limit: Scalars['Int'];
}>;


export type PastLaucnhesListQuery = (
  { __typename?: 'Query' }
...
export const PastLaucnhesListDocument = gql`
    query pastLaucnhesList($limit: Int!) {
  ...
  export class PastLaucnhesListGQL extends Apollo.Query<PastLaucnhesListQuery, PastLaucnhesListQueryVariables> {
    document = PastLaucnhesListDocument;
